...
LiteStat Lite 是 LiteStat 的精简版本，专注于最核心的系统监控功能。它只在菜单栏显示关键指标，没有面板、没有复杂设置，简洁高效。
...
LiteStat 完整版：https://github.com/tzdjack/LiteStat

---

**提示**：如需更多功能（如磁盘监控、电池状态、GPU 使用率等），请使用 [LiteStat 完整版](https://github.com/tzdjack/LiteStat)。
